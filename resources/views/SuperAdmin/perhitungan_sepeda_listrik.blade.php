    ...
    <h1>Perhitungan</h1>
        <div class="row">
            ...
            <table class="table">
                ...
                <tbody>
                    @foreach($data_sepeda->where('tipe' ,"==", "sepeda listrik") as $data)
                    <tr>
            ...
            <table class="table">
                ...
                <tbody>
                    @foreach($data_sepeda->where("tipe","==","sepeda listrik") as $a => $data)
                    <tr>
                        <th scope="row">{{$data->id}}</th>
                        <td>{{$data->nama_sepeda}}</td>
                        <td>{{$data->brand->nama_brand}}</td>
            ...
            <table class="table">
                ...
                <tbody>
                @foreach($sepeda_terbobot_x["sepeda listrik"] as $a => $data)
                    <tr>
                        <th scope="col">X</th>
                        <td scope="col"></td>
                        <td scope="col"></td>
                ...
                <tr>
                        ...
                        <td></td>
                        <td></td>
                        @foreach($total_terbobot_x["sepeda listrik"] as $angka=> $data)
                        <td>{{round($data,3)}}</td>
                        @endforeach
                    </tr>
                </tbody>
            ...
            <table class="table">
                ...
                <tbody>
                @foreach($sepeda_terbobot_x_2["sepeda listrik"] as $a => $data)
                    <tr>
                        <th scope="col">X</th>
                        <td scope="col"></td>
                        <td scope="col"></td>
            ...
            <table class="table">
                ...
                <tbody>
                @foreach($sepeda_terbobot_y["sepeda listrik"] as $a => $data)
                    <tr>
                        <th scope="col">Y</th>
                        <td scope="col"></td>
                        <td scope="col"></td>
            ...
            <table class="table">
                <thead>
                    <tr>
                        <th scope="col">A+</th>
                        @foreach($tahap_3_Solusi_Ideal_Positif["sepeda listrik"] as $a => $data)
                        <td>{{$data}}</td>
                        @endforeach
                    </tr>
                </thead>
                ...
                <tr>
                        <th scope="col">A-</th>
                        @foreach($tahap_3_Solusi_Ideal_Negatif["sepeda listrik"] as $a => $data)
                        <td>{{$data}}</td>
                        @endforeach
                    </tr>
                </tbody>
            ...
            <table class="table">
                ...
                <tbody>
                    @foreach($data_sepeda->where('tipe' ,"==", "sepeda listrik") as $angka => $data)
                    <tr>
                        <td>{{$nilai_D_positif["sepeda listrik"][$angka]}}</td>
                        <td>{{$nilai_D_negatif["sepeda listrik"][$angka]}}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
            ...
            <table class="table">
                ...
                <tbody>
                    @foreach($nilai_preferensi["sepeda listrik"] as $a => $data)
                    <tr>
                        <th>V{{$a}}</th>
                        <td>{{$data["Result"]}}</td>
                        <td>{{$data["Rank"]}}</td>
