...
class PembeliController extends Controller
{
    ...
    public function index()
    {
        ...
        $data_sepeda_listrik=SepedaListrik::where('tipe','sepeda listrik')->count();
        $data_sepeda_motor_listrik=SepedaListrik::where('tipe','sepeda motor listrik')->count();
        ...
        return view('Pembeli.beranda',compact('data_sepeda_listrik','data_sepeda_motor_listrik','data_toko','data_brand','kriteria_all','sepeda_lastest','sepeda_value'));
    }
